...
public class DropBouncerSimulator extends AbstractSimulator {
    ...
    public DropBouncerSimulator(AbstractEquation equation) {
        super(equation);
        
        try {
            image = ImageIO.read(EquationSimulator.class.getResource("images/icon.png"));
